  ...
  export default {
    ...
    watch: {
      graphDataArray: function (newGraphDataArray) {
        if (newGraphDataArray != null) {
          console.log('newGraphDataArray', newGraphDataArray)
    ...
    methods: {
      makeJsonDetailData(graphDataArray) {
        ...
        jsonDetailData = this.arrayToJson(detailData, trainingDate, duration)
      ...
      makeGraph(jsonDetailData) {
        Highcharts.chart('container', {
          ...
          subtitle: {
            text: 'Zoom by selecting a part of the chart'
          },
          xAxis: {
            type: 'datetime'
          },
      ...
      arrayToJson(detailData, startDate, duration) {
        var jsonDetailData = _.map(detailData, function (line) {
          ...
          return {
            ...
            strokeRate: this.getStrokeRate(inputArray[5])
          }
